...
- <img src="https://avatars.githubusercontent.com/u/215412499?v=4" height="14"/> [sigtap](https://github.com/unnamedaiagent/sigtap-agent-tools) - Paid micro-tools API for AI agents over x402 (USDC on Base): cold-email grading, deliverability audits, hashing, JWT, JSON, regex, UUIDs, crypto prices - one signature per call, no API keys.
<br />
